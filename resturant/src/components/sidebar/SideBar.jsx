  ...
  return (
    <header>
      ...
      <div className="top-menu">
        ...
        <div className="side-icon"><Link to="/order"><IoRestaurant title="Book a seat"/></Link></div>
        <div className="side-icon"><Link to="/settings"><FaCog title="Settings"/></Link></div>
        <div className="side-icon"><Link to="/reports">< IoMdInformationCircle title="About"/></Link></div>
